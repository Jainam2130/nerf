...
class _composite_rays_train(Function):
    ...
    def backward(ctx, grad_weights, grad_weights_sum, grad_depth, grad_image):
        ...
        _backend.composite_rays_train_backward(rad_weights, grad_weights_sum, grad_depth, grad_image, sigmas, rgbs, ts, rays, weights_sum, depth, image, M, N, T_thresh, grad_sigmas, grad_rgbs)
